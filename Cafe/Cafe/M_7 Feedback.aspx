<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="M_7 Feedback.aspx.cs" Inherits="Cafe.M_7_Feedback" %>
...
<body>
    <form id="form1" runat="server">
      ...
      <div class="container">
            <h3><center><big><big><b>Feedback</big></big></center></h3>
            <asp:GridView ID="GridViewFeedback" runat="server" AutoGenerateColumns="true" OnSelectedIndexChanged="GridViewFeedback_SelectedIndexChanged">
            </asp:GridView>
        </div>
